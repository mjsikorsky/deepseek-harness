...
export const SERVICE_PAGE: Record<string, string> = {
  ...
  cordisHostActivationPolicy: 'extensions.md',
...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  CordisHostActivationRequest: 'extensions.md',
  CordisHostActivationLease: 'extensions.md',
  OpenInAppAccessLease: 'web-server.md',
  OpenInAppAccessRequest: 'web-server.md',
  ...
  SessionVisibilityReader: 'session.md',
